...
<img src="assets/image-20250707181219960.png" alt="image-20250707181219960" style="width:67%;" />
...
<img src="assets/gsearch1.png" alt="Google 搜索结果“intext: [redacted] inurl:amazonaws.com”显示了指向 Amazon S3 PDF 的链接。" style="width:70%;" />

### 1.3.3 Azure 的 Google 搜索

<img src="assets/gsearch2.png" alt="Google 搜索结果“intext: [redacted] inurl:blob.core.windows.net”显示了 Azure Blob Storage 上的 PDF 文件的链接。" style="width:67%;" />
...
<img src="assets/cloud3.png" alt="HTML 代码片段显示了具有 crossorigin 属性的 DNS 预取和预连接到 [redacted] blob.core.windows.net 的链接。" style="width:67%;" />
...
<img src="assets/cloud1.png" alt="域名状态页面显示 Cloudflare 安全评估结果显示 [已删除] 安全。页面包含社交媒体链接、外部工具、IP 信息以及包含颁发机构和 DNS 名称的 SSL 证书详情。" style="width:67%;" />
...
![仪表板显示 AWS S3 文件列表，其中包含两个条目：来自 [redacted] 存储桶的“id_rsa”和“id_rsa.pub”，日期为 2021 年 8 月。](assets/ghw1.png)
